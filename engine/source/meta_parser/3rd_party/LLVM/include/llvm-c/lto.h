...
extern "C"
{
     ...
     * \since LTO_API_VERSION=18
     */
    extern void thinlto_codegen_set_final_cache_size_relative_to_available_space(thinlto_code_gen_t cg, unsigned percentage);
     ...
     * \since LTO_API_VERSION=18
     */
    extern void thinlto_codegen_set_cache_entry_expiration(thinlto_code_gen_t cg, unsigned expiration);
     ...
     */
    extern void thinlto_codegen_set_cache_size_bytes(thinlto_code_gen_t cg, unsigned max_size_bytes);
     ...
     * \since LTO_API_VERSION=22
     */
    extern void thinlto_codegen_set_cache_size_files(thinlto_code_gen_t cg, unsigned max_size_files);
