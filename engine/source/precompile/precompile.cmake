...
if (CMAKE_HOST_WIN32)
	...
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/PilotParser.exe)
    set(sys_include "*") 
elseif(${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Linux" )
    set(PRECOMPILE_PRE_EXE)
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/PilotParser)
...
COMMAND
    ${PRECOMPILE_PARSER} "${PILOT_PRECOMPILE_PARAMS_PATH}"  "${PARSER_INPUT}"  "${ENGINE_ROOT_DIR}/source" ${sys_include} "Pilot" 0
### BUILDING ====================================================================================
COMMAND
