...
namespace Pilot
{
    ...
    void DirectionalLightShadowPass::setupPipelines()
    {
        ...
        VkShaderModule vert_shader_module =
            PVulkanUtil::createShaderModule(_rhi->_device, MESH_DIRECTIONAL_LIGHT_SHADOW_VERT);
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(_rhi->_device, MESH_DIRECTIONAL_LIGHT_SHADOW_FRAG);
    ...
    void DirectionalLightShadowPass::setupDescriptorSet()
    {
        ...
        mesh_directional_light_shadow_global_descriptor_set_alloc_info.descriptorPool     = _rhi->_descriptor_pool;
