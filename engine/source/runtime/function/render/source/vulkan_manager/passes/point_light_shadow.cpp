...
namespace Pilot
{
    ...
    void PPointLightShadowPass::setupDescriptorSetLayout()
    {
        ...
        mesh_point_light_shadow_global_layout_create_info.bindingCount =
            std::size(mesh_point_light_shadow_global_layout_bindings);
    ...
    void PPointLightShadowPass::setupDescriptorSet()
    {
        ...
        vkUpdateDescriptorSets(m_p_vulkan_context->_device, std::size(descriptor_writes), descriptor_writes, 0, NULL);
    }
