...
namespace Pilot
{
    void PFXAAPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PFXAAPass::setupDescriptorSetLayout()
    {
    ...
    void PFXAAPass::setupPipelines()
    {
        ...
        VkShaderModule vert_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, FXAA_VERT);
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, FXAA_FRAG);
    ...
    void PFXAAPass::setupDescriptorSet()
    {
    ...
    void PFXAAPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PFXAAPass::draw()
    {
        ...
        VkViewport viewport = {0.0,
                               ...
                               0.0,
                               1.0};
        uint32_t x = static_cast<uint32_t>(m_command_info._viewport.x);
        uint32_t y = static_cast<uint32_t>(m_command_info._viewport.y);
        uint32_t width = static_cast<uint32_t>(m_command_info._viewport.width);
        uint32_t height = static_cast<uint32_t>(m_command_info._viewport.height);
