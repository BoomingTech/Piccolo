...
namespace Pilot
{
    void PDirectionalLightPass::initialize()
    {
        setupAttachments();
        setupRenderPass();
        setupFramebuffer();
    ...
    void PDirectionalLightPass::postInitialize()
    {
        setupPipelines();
        setupDescriptorSet();
    }
    void PDirectionalLightPass::draw() { drawModel(); }
    void PDirectionalLightPass::setupAttachments()
    {
        // color and depth
    ...
    void PDirectionalLightPass::setupRenderPass()
    {
    ...
    void PDirectionalLightPass::setupFramebuffer()
    {
    ...
    void PDirectionalLightPass::setupDescriptorSetLayout()
    {
    ...
    void PDirectionalLightPass::setupPipelines()
    {
    ...
    void PDirectionalLightPass::setupDescriptorSet()
    {
    ...
    void PDirectionalLightPass::drawModel()
    {
        struct PMeshNode
        {
