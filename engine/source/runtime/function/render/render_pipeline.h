...
namespace Pilot
{
    ...
    public:
        ...
        virtual void forwardRender(const RHI& rhi, const RenderResourceBase& render_resource) override final;

        virtual void deferredRender(const RHI& rhi, const RenderResourceBase& render_resource) override final;
