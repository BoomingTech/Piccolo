...
namespace Piccolo
{
    ...
    public:
        ...
        virtual void
        createBuffer(RHIDeviceSize size, RHIBufferUsageFlags usage, RHIMemoryPropertyFlags properties, RHIBuffer*& buffer, RHIDeviceMemory*& buffer_memory) = 0;
        ...
        virtual void cmdCopyImageToImage(RHICommandBuffer*      commandBuffer,
                                         ...
                                         uint32_t               height)                                                             = 0;
        virtual void
        cmdCopyBuffer(RHICommandBuffer* commandBuffer, RHIBuffer* srcBuffer, RHIBuffer* dstBuffer, uint32_t regionCount, RHIBufferCopy* pRegions)         = 0;
