...
namespace Pilot
{
    ...
    std::shared_ptr<Pilot::AnimationClip> AnimationLoader::loadAnimationClipData(std::string animation_clip_url)
    {
        ...
        g_global_context.m_asset_manager->loadAsset(animation_clip_url, animation_clip);
    ...
    {
        SkeletonData data;
        g_global_context.m_asset_manager->loadAsset(skeleton_data_url, data);
    ...
    {
        AnimSkelMap data;
        g_global_context.m_asset_manager->loadAsset(anim_skel_map_url, data);
    ...
    {
        BoneBlendMask data;
        g_global_context.m_asset_manager->loadAsset(skeleton_mask_file_url, data);
