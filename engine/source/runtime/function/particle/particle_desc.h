...
namespace Piccolo
{
    ...
    struct ParticleEmitterDesc
    {
        ...
        ParticleEmitterDesc(const ParticleComponentRes& component_res, ParticleEmitterTransformDesc& transform_desc) :
            m_position(transform_desc.m_position), m_rotation(transform_desc.m_rotation), m_velocity(component_res.m_velocity),
            m_acceleration(component_res.m_acceleration), m_size(component_res.m_size), m_emitter_type(component_res.m_emitter_type),
