...
namespace Piccolo
{
	...
	public:
		...
		Quaternion(const Vector3& scaled_axis);
		...
		*/
		...
		static Quaternion QuaternionFromXFormXY(Vector3 x, Vector3 y);

		static Quaternion QuaternionFromCols(Vector3 c0, Vector3 c1, Vector3 c2);
